...
def predict_image(image_path, model, device):
    ...
    image = data_transforms(image).unsqueeze(0).to(device)  # Apply transformations and add batch dimension
...
image_path = 'path to folder'  # Replace with the path to your new image
